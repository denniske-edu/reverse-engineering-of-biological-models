	...
	var parser = (function () {
		...
		function peg$parse(input) {
			var options = arguments.length > 1 ? arguments[1] : {},
				...
				peg$c20 = function (sign) { return parseInt(text(), 10); },
				peg$c21 = /^[a-zA-Z_0-9]/,
				peg$c22 = { type: "class", value: "[a-zA-Z_0-9]", description: "[a-zA-Z_0-9]" },
				peg$c23 = function (sign, letters) { return sign == null ? letters.join('') : new Mult(-1, letters.join('')); },
